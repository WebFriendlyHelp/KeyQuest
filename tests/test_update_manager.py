...
class TestUpdateManager(unittest.TestCase):
    ...
    def test_create_portable_update_launcher_contains_expand_and_robocopy(self):
        ...
        self.assertIn('set "ROBOCOPY_EXCLUDES=progress.json KeyQuest.exe keyquest_error.log"', content)
        self.assertIn('set "ROBOCOPY_EXCLUDE_DIRS=Sentences updates"', content)
        self.assertIn("/MIR", content)
        self.assertIn("/XF %ROBOCOPY_EXCLUDES%", content)
        self.assertIn("/XD %ROBOCOPY_EXCLUDE_DIRS%", content)
