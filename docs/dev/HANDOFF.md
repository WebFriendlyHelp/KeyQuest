...
Verification: unit suite 464 passed + 10,422 subtests; ruff and contrast checks clean. Every new test was run against deliberately reverted or doctored source and fails there.
