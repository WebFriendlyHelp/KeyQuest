...
_PORTABLE_BAT_TEMPLATE = (
    ...
    "robocopy \"%kqExtract%\\KeyQuest\" \"%kqApp%\" /MIR /R:2 /W:1 /NFL /NDL /NJH /NJS /NP /XF progress.json KeyQuest.exe keyquest_error.log pending_update.json sentence_prefs.json /XD Sentences _sentences_incoming updates Backups\r\n"
    ...
    "robocopy \"%kqRestore%\" \"%kqApp%\" %kqRestoreMode% /R:2 /W:1 /NFL /NDL /NJH /NJS /NP /XF progress.json KeyQuest.exe keyquest_error.log pending_update.json sentence_prefs.json .kq_snapshot_complete /XD Sentences _sentences_incoming updates Backups >> \"%kqLog%\" 2>&1\r\n"
...
_PORTABLE_FALLBACK_BAT_TEMPLATE = (
    ...
    " /XF progress.json KeyQuest.exe keyquest_error.log pending_update.json sentence_prefs.json /XD Sentences _sentences_incoming updates Backups\r\n"
    "set \"kqRoboExit=%errorlevel%\"\r\n"
    "if %kqRoboExit% geq 8 (\r\n"
